...
import shule.one.requests.LoginRequest;
import shule.one.requests.SignupRequest;
import shule.one.response.JwtResponse;
import shule.one.response.MessageResponse;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(LoginController.getschoo(),0,signUpRequest.getUsername(), 
